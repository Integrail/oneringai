  ...
  describe('traverse fallback', () => {
    it('falls through to genericTraverse when store lacks traverse()', async () => {
      ...
      const limitedStore: IMemoryStore = {
        ...
        findEntitiesByNormalizedName: shadow.findEntitiesByNormalizedName.bind(shadow),
        atomicCreateOrFindByNormalizedName: shadow.atomicCreateOrFindByNormalizedName.bind(shadow),
  ...
  describe('semanticSearch', () => {
    ...
    it('throws when store lacks semanticSearch', async () => {
      const limitedStore: IMemoryStore = {
        ...
        findEntitiesByNormalizedName: store.findEntitiesByNormalizedName.bind(store),
        atomicCreateOrFindByNormalizedName: store.atomicCreateOrFindByNormalizedName.bind(store),
