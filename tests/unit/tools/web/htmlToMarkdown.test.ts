...
describe('htmlToMarkdown', () => {
  ...
  describe('truncation', () => {
    it('should truncate long content', () => {
      ...
      const result = htmlToMarkdown(html, 'https://example.com', 1000);
    ...
    it('should not truncate short content', () => {
      ...
      const result = htmlToMarkdown(html, 'https://example.com', 50000);
    ...
    it('should truncate at paragraph boundary when possible', () => {
      ...
      const result = htmlToMarkdown(html, 'https://example.com', 100);
  ...
  describe('readability', () => {
    it('should report when readability was used', () => {
      const html = `
        <html>
